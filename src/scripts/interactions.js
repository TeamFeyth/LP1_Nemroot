...
// LP1 spec, Section 5 / 4: the build gap lists "a show-once-per-session rule"
// as required. LP2's spec instead describes once-per-page-load. Set per page.
